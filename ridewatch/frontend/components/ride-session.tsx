...
import { endRide, getRide, formatDistance, formatDuration, type Ride } from "@/lib/api";
export default function RideSession({ rideId }: { rideId: string }) {
  ...
  async function finish() {
    ...
    try { setRide(await endRide(rideId)); } catch (e) { setError(e instanceof Error ? e.message : "Unable to end ride."); }
